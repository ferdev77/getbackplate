...
**Última Actualización:** 4 de Junio de 2026 (ver CHANGELOG.md para historial completo de cambios).
...
4. **Cron QBO/R365:** ~~Pendiente~~ **✅ Activo en producción.** El cron `/api/webhooks/cron/qbo-r365-sync` está declarado en `vercel.json` y corre 10 veces al día (`0 0,4,10,12,14,16,18,20,21,22 * * *`). La integración QBO→R365 está en producción con clientes activos.
