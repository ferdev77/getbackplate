      ...
      <section className="mb-5 rounded-2xl border border-[#e7e0dc] bg-[#fffdfa] p-6 [.theme-dark-pro_&]:border-[#2b3646] [.theme-dark-pro_&]:bg-[#151b25]">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="space-y-2">
            ...
            <div className="h-7 w-52 rounded bg-gray-200 [.theme-dark-pro_&]:bg-[#263244]" />
          </div>
          <div className="h-9 w-40 rounded-lg bg-gray-200 [.theme-dark-pro_&]:bg-[#263244]" />
        </div>
      </section>
      ...
      <section className="space-y-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <article key={i} className="rounded-xl border border-[#e8e8e8] bg-white px-5 py-4 [.theme-dark-pro_&]:border-[#2b3646] [.theme-dark-pro_&]:bg-[#151b25]">
            <div className="h-5 w-44 rounded bg-gray-200 [.theme-dark-pro_&]:bg-[#263244]" />
            <div className="mt-2 h-4 w-64 rounded bg-gray-100 [.theme-dark-pro_&]:bg-[#1b2737]" />
