  ...
  if (catalog === "directory_page") {
    ...
    const employeeRows = viewData.employees.map((emp) => {
      ...
      return {
        ...
        hiredAt: emp.hiredAt,
        branchName: emp.branchName ?? "Sin ubicación",
    ...
    const userRows = (organizationUserProfiles ?? []).map((profile) => {
      ...
      return {
        ...
        hiredAt: null,
        branchName: profile.branch_id ? (branchNameById.get(profile.branch_id) ?? "Sin ubicación") : "Sin ubicación",
