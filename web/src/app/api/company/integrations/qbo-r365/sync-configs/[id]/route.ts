...
export async function GET(_req: Request, { params }: Params) {
  ...
  try {
    ...
    if (!config) return NextResponse.json({ error: "Synchronization not found." }, { status: 404 });
    return NextResponse.json({ config }, { status: 200 });
  } catch {
    return NextResponse.json(
      { error: "Unable to load the synchronization. Please try again." },
      { status: 400 },
    );
  }
}
...
export async function PUT(request: Request, { params }: Params) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: "Unable to update the synchronization. Please try again." },
      { status: 400 },
    );
  }
}
...
export async function DELETE(_req: Request, { params }: Params) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: "Unable to delete the synchronization. Please try again." },
      { status: 400 },
    );
  }
}
