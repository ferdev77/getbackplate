...
export const COMPANY_SHELL_EN: Record<string, string> = {
  ...
  "sin leer": "unread",
  "No tienes notificaciones todavía.": "You don't have any notifications yet.",
  "Ver todas": "View all",
  "Todas": "All",
  "En la app": "In-app",
  "Push activado": "Push enabled",
  "Push desactivado — Activar": "Push disabled — Enable",
  "Push bloqueado": "Push blocked",
  "Bloqueaste las notificaciones para este sitio. Habilítalas desde la configuración del navegador (ícono de candado junto a la URL) y recarga la página.":
  ...
  "No se pudo activar. Revisa el permiso de notificaciones del navegador.": "Could not enable. Check your browser's notification permission.",
  "Notificaciones activadas": "Notifications enabled",
  "Activa las notificaciones para no perderte novedades importantes": "Enable notifications so you don't miss important updates",
  "Activar": "Enable",
  ...
  "Elige tu plan de integración QuickBooks": "Choose your QuickBooks integration plan",
  "Tu prueba venció — reactiva tu suscripción": "Your trial has expired — reactivate your subscription",
  "Elige tu plan para desbloquear el panel": "Choose a plan to unlock the dashboard",
  "Contrata un plan de plataforma para gestionar tu operación, o un plan de integración para conectar QuickBooks® Online con R365.": "Choose a platform plan to manage your operation, or an integration plan to connect QuickBooks® Online to R365.",
  ...
  "Gestionar →": "Manage →",
  "Conecta QuickBooks Online con Restaurant365 y sincroniza facturas automáticamente.": "Connect QuickBooks Online to Restaurant365 and sync invoices automatically.",
  "Conecta tu QuickBooks Online con Restaurant365 y sincroniza facturas automáticamente. No requiere un plan de plataforma.": "Connect QuickBooks Online to Restaurant365 and sync invoices automatically. No platform plan is required.",
