...
const SECTIONS: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/app/employees?tab=users", label: "Usuarios", icon: User, moduleCode: "employees" },
      { href: "/app/employees?action=create-user", label: "Nuevo Usuario", icon: UserPlus, sub: true, moduleCode: "employees" },
