           ...
           <div className="flex items-center justify-between gap-3 border-t border-[var(--gbp-border)] bg-[var(--gbp-surface)] p-6 px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <SubmitButton
                ...
                className="rounded-full bg-[var(--gbp-text)] px-10 py-2.5 text-sm font-bold text-white shadow-lg transition-transform hover:scale-[1.02] hover:bg-[var(--gbp-accent)] active:scale-[0.98]"
              />
            </div>
          </div>
        </form>
