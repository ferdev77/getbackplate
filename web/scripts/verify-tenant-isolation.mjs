...
async function verifyIsolation(client) {
  ...
  try {
    ...
    console.log("OK: aislamiento documentos validado (empleado A permitido, empleado B bloqueado).");
    console.log("OK: aislamiento checklists validado (empleado A permitido, empleado B bloqueado).");
    console.log("OK: aislamiento anuncios validado (empleado A permitido, empleado B bloqueado).");
...
main().catch((error) => {
  console.error("ERROR verify-tenant-isolation:", error.message);
  process.exit(1);
});
