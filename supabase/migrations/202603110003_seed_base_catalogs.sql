-- Seed base de catalogos para entornos remotos
...
values
  ...
  ('announcements', 'Avisos', 'Comunicacion interna segmentada', true),
...
values
  ...
  ('announcements.read', 'announcements', 'Leer avisos'),
  ('announcements.write', 'announcements', 'Publicar avisos'),
