ALTER TABLE public.development_ledger_items DROP CONSTRAINT IF EXISTS development_ledger_items_work_type_check;
...
UPDATE public.development_ledger_items SET work_type = 'improvement', updated_at = now() WHERE stable_key IN ('i1-10', 'i3-11', 'i3-13', 'i4-4', 'i4-6', 'i4-7', 'i4-8', 'i4-9', 'i5-12', 'i6-6', 'i7-5', 'p1-9', 'p2-14', 'p2-15', 'p2-18', 'p3-10', 'p5-2', 'p5-3', 'p5-5', 'p5-6', 'p5-10', 'p5-11', 'p6-3', 'p6-4', 'p6-6', 'p7-4', 'p8-3', 't3-1', 't3-2', 't3-3', 't4-1');
...
SET html_document = $development_report_20260807000006$<!doctype html>
<html lang="es">
<head>
<meta charset="utf-8">
...
<div class="wrap">
  ...
  <section class="draft-note">
    ...
    <p>Cada área lleva al lado su estado. Las marcadas <b>Facturado anteriormente</b> ya se le facturaron al owner y no llevan
  ...
  <div class="body-grid">
    ...
    <main>
      ...
      <section class="section i" id="i8">
        ...
        mediante un único precio general, sin inputs individuales.</p>
...
<div class="totbar">
  <div class="totbar-in">
    <div class="tot"><span class="tot-l">Ítems facturados anteriormente</span><span class="tot-n paid" id="tPaid">0</span></div>
...
(function () {
  ...
  /* ==================================================================
     ...
     ya le facturaste al owner, va como COBRADO aunque se haya tocado en
...
$development_report_20260807000006$,
    content_sha256 = 'd29480b109a23a0fa2aaf77e29afaa710646eddb0e2f7d289c191e1fbabd7e2a',
    snapshot = jsonb_set(snapshot, '{contentSha256}', to_jsonb('d29480b109a23a0fa2aaf77e29afaa710646eddb0e2f7d289c191e1fbabd7e2a'::text), true),
    updated_at = now()
