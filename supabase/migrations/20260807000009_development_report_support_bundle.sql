...
SET html_document = $development_report_20260807000009$<!doctype html>
<html lang="es">
<head>
<meta charset="utf-8">
...
<div class="wrap">
  ...
  <div class="body-grid">
    ...
    <main>
      ...
      <article class="section p" id="p7" data-single-price="true">
        <h3>2.7 · Soporte</h3>
...
$development_report_20260807000009$,
    content_sha256 = '4135ccdf77e9b0940ccab2af86a4b6df1a6b3c26773682e133aa15bbddd947f3',
    snapshot = jsonb_set(report.snapshot, '{contentSha256}', to_jsonb('4135ccdf77e9b0940ccab2af86a4b6df1a6b3c26773682e133aa15bbddd947f3'::text), true),
